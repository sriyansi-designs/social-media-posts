...
- Colour carries the state: violet while tangled, blue once resolved at the
  surface. In beat 5 the bundle is deliberately re-lit brighter to pull the
  eye back above the line, because that is the beat where the point lands.
...
| 13.2 - 16.2 | Bundle re-lights brighter, counts appear. "The mess didn't vanish. Someone is *holding* it." |
